...
if args.model == 'sia':
    ...
    optimizer = Adamax(net.parameters(), lr=1e-3, eps=1e-8, weight_decay=1e-4)
...
net_parameters_path = "D:\shiyao_DataSet\复现其他两个网络\exp\cvt\hill0.2"
