...
def project_test(test_cover_dir, test_stego_dir, net):
    ...
    print('prg test time: %.3f' % prgtime)
    return prgtime
...
if __name__ == '__main__':
    ...
    # 加载最佳模型
    model_best_path = "D:\shiyao_DataSet\复现其他两个网络\exp\Vsize\siapart2"
    best_ckpt = os.path.join(model_best_path, 'epoch159checkpoint.pth.tar')  # epoch115checkpoint
