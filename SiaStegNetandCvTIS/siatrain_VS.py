...
def parse_args():
    ...
    parser.add_argument('--epoch', dest='epoch', type=int, default=170)  # default=1000
    parser.add_argument('--random-crop', dest='random_crop', action='store_true', default=False)  # action='store') # 用于开启随机裁剪
